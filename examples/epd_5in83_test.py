...
try:
    ...
    font24 = ImageFont.truetype(os.path.join(picdir, 'Font.ttf'), 24)
    font18 = ImageFont.truetype(os.path.join(picdir, 'Font.ttf'), 18)
    ...
    Himage = Image.open(os.path.join(picdir, 'jolly.bmp'))
    epd.display(epd.getbuffer(Himage))
    time.sleep(2)
